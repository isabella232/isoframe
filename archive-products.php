...
<div class="category-<?php echo $term->term_id; ?>">
  <div class="frameFinder__results">
    ...
    <img src="<?php the_field('category_image', 'term_' . $term->term_id); ?>"><br />
          <img src="<?php the_field('smaller_image1', 'term_' . $term->term_id); ?>" style="height:120px; width:auto!important;"> 
      <img src="<?php the_field('smaller_image2', 'term_' . $term->term_id); ?>" style="height:120px; width:auto!important;">
